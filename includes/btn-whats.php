...
.wa__popup_chat_box_ct .wa__popup_heading_ct:before {
    content: '';
    background: url('/assets/images/whatsapp_logo.png') center top no-repeat;
...
<div class="wa__btn_popup">
    <div class="wa__btn_popup_txt">¿Quieres una reservación? <strong>Contáctenos</strong></div>
...
<div class="wa__popup_chat_box">
    <div class="wa__popup_heading">
        <div class="wa__popup_title">¡Agenda hoy tu reserva!</div> <br>
    ...
    <div class="wa__popup_content wa__popup_content_left">
        <div class="wa__popup_notice"> Disfruta de una exquisita comida</div>


        <div class="wa__popup_content_list">
            <div class="wa__popup_content_item ">
                <a target="_blank"
                    href="https://wa.me/+526241308444?text=Hola,%20me%20gustaría%20agendar%20una%20reservación"
                    class="wa__stt wa__stt_online">
                    <div class="wa__popup_avatar">
                        <div class="wa__cs_img_wrap">
                            <img style="width: 3rem;" src="/assets/images/chat.webp" alt="">
                        </div>
                    </div>

                    <div class="wa__popup_txt">
                        <div class="wa__member_name">La Ramona</div>
                        <!-- /.wa__member_name -->
                        <div class="wa__member_duty">Comida Campesina de Vanguardia</div>
                        <!-- /.wa__member_duty -->
                    </div>
                    <!-- /.wa__popup_txt -->
                </a>
