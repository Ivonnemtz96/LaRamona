        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="banner-two-content">
                    <span data-cue="slideInLeft" data-duration="1500">Welcome To The Ruzo</span>
                    <h1 data-cue="slideInLeft" data-duration="1800">
                        Organic & Fresh Coffee House
                    </h1>
                    <p data-cue="slideInLeft" data-duration="2500">
                        On the other hand, we denounce with righteous indignation and
                        dislike men who are so beguiled an item by the charms of
                        pleasure of the moment with a righteous hand.
                    </p>
                    <ul>
                        <li data-cue="slideInLeft" data-duration="1500">
                            <a href="about.html" class="default-btn">Explore More</a>
                        </li>
                        <li data-cue="slideInLeft" data-duration="2500">
                            <a href="booking-table.html" class="default-btn">Get Delivery</a>
                        </li>
                    </ul>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 col-md-6" data-cue="slideInUp">
                <div class="single-features-card">
                    ...
                    <p>
                        All the lorem ipsum generators on the predefined t tend to
            ...
            <div class="col-lg-6">
                <div class="single-about-two-content">
                    <div class="section-title left-title">
                        ...
                        <p>
                            On the other hand, we denounce with righteous indignation and
                            dislike men who areantis beguiled aitem demora lized by the
...
<div class="portfolio-two-area pt-100 pb-70 jarallax" data-jarallax='{"speed": 0.3}'>
    <div class="container">
        <div class="section-title left-title">
    ...
    <div class="container">
        ...
        <div class="special-menu-tabs">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="coffee-tab" data-bs-toggle="tab" data-bs-target="#coffee-tab-pane"
                        type="button" role="tab" aria-controls="coffee-tab-pane" aria-selected="false">
                        Coffee
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="chocolate-tab" data-bs-toggle="tab"
                        data-bs-target="#chocolate-tab-pane" type="button" role="tab" aria-controls="chocolate-tab-pane"
                        aria-selected="false">
                        Chocolate
                    </button>
                </li>
            ...
            <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-6">
                                            <div class="special-menu-text">
                                                ...
                                                <p>2/3 espresso, 1/3 steamed milk</p>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6 col-6">
                                            <div class="special-menu-text">
                                                ...
                                                <p>2/3 steamed milk, 1/3 espresso</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-2">
                                            <div class="special-menu-number">
                ...
                <div class="tab-pane fade" id="coffee-tab-pane" role="tabpanel" aria-labelledby="coffee-tab"
                    tabindex="0">
                    <div class="single-special-menu-content">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                ...
                <div class="tab-pane fade" id="chocolate-tab-pane" role="tabpanel" aria-labelledby="chocolate-tab"
                    tabindex="0">
                    <div class="single-special-menu-content">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
        ...
        <div class="special-view-btn">
            <a href="menu.html" class="default-btn">View All Menu</a>
        </div>
    </div>
...
<div class="visit-two-area pt-100 pb-100">
    <div class="container">
        <div class="visit-two-form-content">
            <div class="row">
                <div class="col-lg-6">
...
<div class="top-grade-area pt-100 pb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <div class="top-grade-right-content">
                    <div class="section-title left-title">
                        <span class="top-title">Top Grade</span>
                        <h2>Top Grade Coffee In The World</h2>
                        <p>
                            There are many variations of passages of Lorem availa but the
...
<div class="location-two-area pt-100 pb-100">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
                <div class="single-location-content location-two-content">
                    <div class="section-title left-title">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 col-md-4">
                            <div class="location-list">
                                <ul>
                                    <li><i class="bx bx-check"></i>Dummy voluptatem</li>
                                    <li><i class="bx bx-check"></i>Accusantium</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-md-4">
                            <div class="location-list">
                                <ul>
                                    <li><i class="bx bx-check"></i>Typesetting</li>
                                    <li><i class="bx bx-check"></i>Popular belief</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-4 col-md-4">
                            <div class="location-list">
                                <ul>
                                    <li><i class="bx bx-check"></i>Established</li>
                                    <li><i class="bx bx-check"></i>Many variations</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="blog-two-area pt-100 pb-70">
    <div class="container">
        ...
        <div class="blog-two-slider owl-carousel owl-theme">
            <div class="blog-card-two-content">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="single-blog-content">
                            ...
                            <a href="blog-details.html">
                                <h3>Elegant Derrert 10Tips How To Make It At Home</h3>
                            </a>
                            <p>
                                At vero eos the accusamus iusto odio dignissimos ducimus qui
                                blanditi.
                            </p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="single-blog-content">
                            ...
                            <a href="blog-details.html">
                                <h3>Surkish Soup With Species Dish Of The Week</h3>
                            </a>
                            <p>
                                At vero eos the accusamus iusto odio dignissimos ducimus qui
                                blanditi.
